    ...
    public AuthorizationResult<GraphQLObligation> getGraphQLAuthorizationResult(
        ...
        try {
            ...
            HttpResponse pdpResponse = _pdpClient.request(pdpURI)
                    ...
                    .body(fromString(pdpRequestBody, Charset.forName("UTF-8")))
                    .post()
                    .response();
            ...
            if(hasObligations)
            {
                ...
                curityAuthzObligation = (GraphQLObligation) new XacmlFilterObligation(obligationAttributes);
            }
            ...
            switch (decision) {
                case "Permit":
                    _logger.debug("The PDP decision is Permit");
